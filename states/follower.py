...
from .common import get_next_election_timeout, RAFTStates, RAFTStateInfo
...
class RAFTFollower:
    ...
    def __init__(self, state_machine: state.RAFTStateMachine, state: RAFTStateInfo, node: Node) -> None:
    ...
    def __on_append_msg(self, sock: Connection, msg: str) -> None:
